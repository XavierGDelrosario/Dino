...
export const en = {
  ...
  "quiz.wordsTitle": "Words in this quiz", // aria-label only — the list has no visible title
  ...
  "quiz.showExample": "Show example",
  "quiz.hideExample": "Hide example",
...
export const ja: Record<MessageKey, string> = {
  ...
  "quiz.showExample": "例文を表示",
  "quiz.hideExample": "例文を隠す",
