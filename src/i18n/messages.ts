...
export const en = {
  ...
  "tabs.learn": "Learn",
  "tabs.review": "Review",
  "media.intro": "Study real Japanese from the news. Pick an article to read it word-by-word.",
  ...
  "listen.glossEmpty": "No translation came back — the translator may be over quota or unavailable.",
  "listen.addAll": "＋ Add {n} new {noun}",
  "listen.quizNew": "Quiz {n} new {noun}",
...
export const ja: Record<MessageKey, string> = {
  ...
  "tabs.learn": "学習",
  "tabs.review": "復習",
  "media.intro": "ニュースで本物の日本語を学ぼう。記事を選んで単語ごとに読めます。",
  ...
  "listen.tool": "会話を聞き取る",
  "listen.glossEmpty": "翻訳が返ってきませんでした。利用上限に達しているか、一時的に使えない可能性があります。",
  "listen.addAll": "＋ 新出{n}{noun}を追加",
  "listen.quizNew": "新出{n}{noun}をクイズ",
